...
my_user=['1043453579@qq.com','563274687@qq.com'] # 收件人邮箱账号，
async def mail(my_user):
    try:
        msgroot = MIMEMultipart('related',)
        msg=MIMEText('填写邮件内容<a href="aaaaaa">这里是一个跳转链接</a><h1>图片演示</h1><p><img src="cid:image1"></p>','html','utf-8')
        msgroot.attach(msg)
...
if len(my_user)>1:
    ...
    look.run_until_complete(mail(my_user))
look.close()